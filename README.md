...
> [!IMPORTANT]
> As funcionalidades presentes neste _software_ foram transferidas para o [table2spatial](https://github.com/GabrielMaccari/table2spatial), e o Stereographer **não** receberá mais atualizações e correções de bugs.

<div align="center"/>
  <br>
  <img src="https://github.com/FrostPredator/stereographer/assets/114439033/574ba051-804a-480f-9e18-73b319ccdbce">
</div>
...
> [!NOTE]
> Para arquivos CSV, você deve utilizar ponto e vírgula (;) como delimitador de campo.
...
Em seguida, você deve selecionar na interface as colunas da sua tabela que contêm cada componente da medida estrutural. Usando a tabela de exemplo apresentada anteriormente, e considerando que tenhamos selecionado "Rakes: Strike/Dip/Pitch" para o tipo de medida, o componente "Strike" seria a coluna _Direcao_plano_falha_, por exemplo.
...
> [!NOTE]
> Números decimais (ex: 180,50) podem ser utilizados, mas você deve usar ponto (.) como separador decimal caso insira ou edite os dados manualmente na interface do Stereographer.
